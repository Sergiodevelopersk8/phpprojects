...
function validarformulario(){
	...
	document.formregistro.email.value=="" || document.formregistro.direccion.value=="" || 
	document.formregistro.cp.value=="" || document.formregistro.estado.value=="" || document.formregistro.password1.value=="" || document.formregistro.password2.value==""){
...
$.ajax({
	...
	data:{"nombre":nombre,"apellidos":apellidos,"email":email,"direccion":direccion,"estado":estado,"cp":cp,"telefono":telefono,"password":password},
...
function validadonombre(){
	...
	document.formregistro.nombre.style.border="2px solid purple";
