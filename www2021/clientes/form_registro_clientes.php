...
<div class="main">
  ...
  <form name="formregistro" action="registro_clientes.php" method="post">
    <div class="form-group">
      <label>Nombre*</label>
      <input  onKeyPress="validadocampos()"  onKeyUp="validadonombre()"   type="tex" name="nombre" pattern="[A-Za-z0-9_-]{1,15}" required class="form-control" placeholder="Nombre"  >
    </div>
    <div class="form-group">
    ...
    <button type="button" onClick="validarformularioderegistrodeusuario()" class="btn btn-default">Enviar</button>
  </form>
